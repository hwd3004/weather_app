...
<View style={styles.halfContainer} style={styles.textContainer}>

위 코드에서, 2개의 오브젝트를 함쓰는 es6 방식으로

<View style={{...styles.halfContainer, ...styles.textContainer}}>

으로 하면 된다는데, 나는 이게 안되어서
...
Weather.js에서 Weather.propTypes에 없는 날씨를 받아온다면 에러가 날텐데,
안드로이드 스튜디오를 이용하면, 에러를 dismiss 하면 무슨 날씨가 없어서 에러가 나는지 확인 가능.
